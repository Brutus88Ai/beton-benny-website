        ...
        >
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 mb-12">
                    ...
                    <Card
                        isDark={isNightShift}
                        className="flex flex-col items-center text-center p-0 overflow-hidden"
                    >
                        ...
                        <div className="w-full relative bg-[#121212] p-4 flex flex-col gap-4">
                            ...
                            <div className="flex justify-between items-center text-white px-4">
                                ...
                                <div className="bg-white text-black rounded-full p-3 hover:scale-105 transition-transform">
                            ...
                            <a
                                ...
                                className="text-[#1DB954] text-xs font-bold text-center mt-2 border border-[#1DB954] rounded-full py-1 px-4 self-center uppercase cursor-pointer hover:bg-[#1DB954] hover:text-black transition-colors flex items-center gap-2"
                            >
                                Auf Spotify anhören
                            </a>
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-neonOrange text-black text-xs font-bold text-center mt-2 border-2 border-black rounded-full py-2 px-4 self-center uppercase cursor-pointer hover:bg-signalYellow transition-colors flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
                            >
                    ...
                    {/* SOUNDBOARD CARD */}
                    <Card isDark={isNightShift} className="relative">
                        <div className="absolute -top-4 -right-4 bg-neonOrange text-black font-bold px-4 py-2 transform rotate-3 shadow-md border-2 border-black z-10">
                            SOUNDBOARD
                        </div>
